...
> To get PATH, open a terminal, type `echo %PATH%`, and press enter.

![](resources/path-echo.png)  
...
::: {.column-margin}
**Resource:**  
[Using the `py` command (Real Python)](https://realpython.com/run-python-scripts/#using-the-python-command)
:::  

![](resources/py-version.png)  
